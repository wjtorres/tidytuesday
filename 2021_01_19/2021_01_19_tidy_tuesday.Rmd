...
my_theme <- theme(
  ...
  # title
  plot.title = element_text(family = "one", size = 20, hjust = .5, color = d_grey, margin = margin(10, 0, 10, 0)),
...
my_plot <- crops2 %>%
  ...
  labs(title = "Crop growth in Kenya by type and county",
       subtitle = "For each crop, the numbers represent the percentage of households in the county \ngrowing the crop (based on data available from the 2019 Kenya Population and Housing Census).",
