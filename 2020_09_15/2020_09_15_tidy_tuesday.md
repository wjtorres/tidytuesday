...
```
## --- Compiling #TidyTuesday Information for 2020-09-15 ----
```
...
```
## `summarise()` regrouping output by 'variable2' (override with `.groups` argument)
```
...
![](2020_09_15_tidy_tuesday_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
