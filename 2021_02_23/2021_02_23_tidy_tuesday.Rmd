...
my_theme <- theme(
  ...
  # title
  plot.title = element_text(family = "one", size = 14, hjust = 0, margin = margin(10, 0, 0, 0), color = d_grey),
  
  # subtitle
  plot.subtitle = element_text(family = "one", size = 14, hjust = 0, margin = margin(0, 0, 10, 0), color = d_grey),
  
  # caption
  plot.caption = element_text(family = "one", size = 6, hjust = 0, margin = margin(10, 0, 10, 0), color = d_grey),
  ...
  # customize y axis
  axis.text = element_text(family = "two", size = 9, color = d_grey),
